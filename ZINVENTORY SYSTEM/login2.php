...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    if ($stmt->num_rows > 0) {
        ...
        if ($position === "Inventory Officer" || $position === "Inventory Associate" || $position === "Production Clerk" || $position === "Inventory Controller"){
            $invaliduserpass = "Access denied. " . '<b><a href = "login.php">Go here instead.</a></b>';
        } else {
        session_start();
        $_SESSION['user_id'] = $id;
        $_SESSION['name'] = $name;
...
<body>
    <div id="login-container">
        ...
        <p id="text2">Don't have an account? <b><a href="register2.php" id="sign-up-link">Sign up.</a></b></p>
    </div>

        ...
        <div class="form-container">
            ...
            <form action="process_order.php" method="post">
                ...
                <select name="productName" id="productNameSelect">
                    ...
                    $result = $conn->query("SELECT productName, price FROM pcmtable WHERE productStatus = 'Available'");
                    while ($row = $result->fetch_assoc()) {
                        echo "<option value='" . $row['productName'] . "' data-price='" . $row['price'] . "'>" . $row['productName'] . "</option>";
                    }
                    ?>
                </select>
                ...
                <label for="customerTelNum">Telephone Number</label>
                <input type="tel" name="customerTelNum" required>
                ...
                <table id="ordersTable">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='delete_order.php?orderID=" . $row['orderID'] . "' style='text-decoration: none; color: red;'>Delete</a> or <a href='update_status.php?orderID=" . $row['orderID'] . "' style='text-decoration: none; color: green;'>Update Status</a></td>";
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
